                      ...
                      <div class="mb-3">
                        <div class="mt-2">
                          ...
                          <select class="form-select" name="personal" id="personlSelect" aria-label="Default select example">
                            ...
                            $query = "SELECT * FROM personal WHERE PersonalEstado = 'Activo' AND DAY(PersonalUltimaEntrada) != '$dia' AND MONTH(PersonalUltimaEntrada) != '$mes' AND YEAR(PersonalUltimaEntrada) != '$ano' ORDER BY PersonalNombre ASC";
